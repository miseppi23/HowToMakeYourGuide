...
2. Once created click on **Publish repository** in Github Desktop main window.

![](media/Picture24.png)

3. If you go the the **History** tab, you can change what has been publish. You should see all your repository.
...
Now that you created your pages and that your repository have been publish on Github, we will deploy your website using **Github Pages**.
...
::: {.callout-note}
If you are still visualising the preview of your website using ``CTRL+SHIFT+K``, you will notice that your terminal is busy. 
In order to kill the command, click on your terminal and use ``CTRL+C``.
:::

2. Go to the ``SOURCE CONTROL`` tab on the left side bar of VS code. You'll see there is several changes stashed. You will commit them to github.

![](media/Picture28.png)

3. Click on the **+** sign **Staged All Changes**. 
